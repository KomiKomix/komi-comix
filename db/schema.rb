...
ActiveRecord::Schema.define(version: 20161227151419) do
  ...
  create_table "spree_social_links", force: :cascade do |t|
  ...
  add_index "spree_social_links", ["url"], name: "index_spree_social_links_on_url", unique: true
